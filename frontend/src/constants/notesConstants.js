...
export const NOTES_LIST1_REQUEST = "NOTES_LIST1_REQUEST";
export const NOTES_LIST1_SUCCESS = "NOTES_LIST1_SUCCESS";
export const NOTES_LIST1_FAIL = "NOTES_LIST1_FAIL";
